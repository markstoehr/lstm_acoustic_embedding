...
def train_siamese_triplets_lstm_nn(options_dict):
    ...
    model = siamese.SiameseTripletBatchLSTMNN(
        rng, x1, x2, x3, m1, m2, m3, n_in=39, n_lstm_hiddens=options_dict["n_hiddens"], mlp_hidden_specs=options_dict["hidden_layer_specs"])
...
def main():
    ...
    train_siamese_triplets_lstm_nn(options_dict)
