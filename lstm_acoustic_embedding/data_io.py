...
#         x1_indices = np.asarray(x1_indices, dtype=THEANOTYPE)
#         x2_indices = np.asarray(x2_indices, dtype=THEANOTYPE)
#         y = np.asarray(y, dtype=THEANOTYPE)
...
#         shared_x = theano.shared(np.asarray(data_x, dtype=THEANOTYPE), borrow=borrow)
#         shared_y = theano.shared(np.asarray(data_y, dtype=THEANOTYPE), borrow=borrow)
