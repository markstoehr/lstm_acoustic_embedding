...
class SiameseTripletBatchLSTMNN(object):
    """
    ...
    def __init__(self, rng, input_x1, input_x2, input_x3, input_m1, input_m2, input_m3, n_in, n_lstm_hiddens, mlp_hidden_specs):
        """
        ...
        self.model = lstm.BatchMultiLayerLSTMNN(
            rng, input, mask, n_in, n_lstm_hiddens, mlp_hidden_specs,  output_type="last", prefix="lstmsnn")
        self.n_layers = len(self.model.layers)
        
        self.x1_model = lstm.BatchMultiLayerLSTMNN(
            rng, input_x1, input_m1, n_in, n_lstm_hiddens, mlp_hidden_specs, lstm_parameters=self.model.lstm_parameters,
            mlp_parameters=self.model.mlp_parameters,
            output_type="last", prefix="lstmsnn_x1")
        self.x2_model = lstm.BatchMultiLayerLSTMNN(
            rng, input_x2, input_m2, n_in, n_lstm_hiddens, mlp_hidden_specs, lstm_parameters=self.model.lstm_parameters,
            mlp_parameters=self.model.mlp_parameters,
            output_type="last", prefix="lstmsnn_x2")
        self.x3_model = lstm.BatchMultiLayerLSTMNN(
            rng, input_x3, input_m3, n_in, n_lstm_hiddens, mlp_hidden_specs, lstm_parameters=self.model.lstm_parameters,
            mlp_parameters=self.model.mlp_parameters,
            output_type="last", prefix="lstmsnn_x3")
...
class SiameseTripletBatchConvLSTM(object):
    ...
    def __init__(self, rng, input_x1, input_x2, input_x3, input_m1, input_m2, input_m3, input_shape, filter_shape, n_lstm_hiddens, n_outputs, prefix="triplet_convlstm", output_type="max", truncate_gradient=-1, srng=None, dropout=0.0, use_dropout_regularization=False, stabilize_activations=None):
        """
        Initialize symbolic parameters and expressions.
        ...
        self.model = lstm.BatchMultiLayerConvLSTM(
            ...
            output_type=self.output_type, prefix="%s_lstm" % self.prefix, truncate_gradient=self.truncate_gradient, srng=self.srng, dropout=self.dropout, use_dropout_regularization=self.use_dropout_regularization, stabilize_activations=self.stabilize_activations)
        ...
        self.x1_model = lstm.BatchMultiLayerConvLSTM(
            ...
            output_type=self.output_type, prefix="%s_lstm1" % self.prefix, truncate_gradient=self.truncate_gradient, srng=self.srng, dropout=self.dropout, out_W=self.model.out_W, out_b=self.model.out_b, use_dropout_regularization=self.use_dropout_regularization, stabilize_activations=self.stabilize_activations)
        self.x2_model = lstm.BatchMultiLayerConvLSTM(
            ...
            output_type=self.output_type, prefix="%s_lstm2" % self.prefix, truncate_gradient=self.truncate_gradient, srng=self.srng, dropout=self.dropout, out_W=self.model.out_W, out_b=self.model.out_b, use_dropout_regularization=self.use_dropout_regularization, stabilize_activations=self.stabilize_activations)
        self.x3_model = lstm.BatchMultiLayerConvLSTM(
            ...
            output_type=self.output_type, prefix="%s_lstm3" % self.prefix, truncate_gradient=self.truncate_gradient, srng=self.srng, dropout=self.dropout, out_W=self.model.out_W, out_b=self.model.out_b, use_dropout_regularization=self.use_dropout_regularization, stabilize_activations=self.stabilize_activations)
...
class SiameseTripletLSTMNN(object):
    ...
    def __init__(self, rng, input_x1, input_x2, input_x3, n_in, n_lstm_hiddens, mlp_hidden_specs):
        """
        Initialize symbolic parameters and expressions.
        ...
        self.n_lstm_hiddens = n_lstm_hiddens
        self.mlp_hidden_specs = mlp_hidden_specs
        self.model = lstm.MultiLayerLSTMNN(
            rng, input, n_in, n_lstm_hiddens, mlp_hidden_specs,  output_type="last", prefix="lstmsnn")
        self.n_layers = len(self.model.layers)
        
        self.x1_model = lstm.MultiLayerLSTMNN(
            rng, input_x1, n_in, n_lstm_hiddens, mlp_hidden_specs, lstm_parameters=self.model.lstm_parameters,
            mlp_parameters=self.model.mlp_parameters,
            output_type="last", prefix="lstmsnn_x1")
        self.x2_model = lstm.MultiLayerLSTMNN(
            rng, input_x2, n_in, n_lstm_hiddens, mlp_hidden_specs, lstm_parameters=self.model.lstm_parameters,
            mlp_parameters=self.model.mlp_parameters,
            output_type="last", prefix="lstmsnn_x2")
        self.x3_model = lstm.MultiLayerLSTMNN(
            rng, input_x3, n_in, n_lstm_hiddens, mlp_hidden_specs, lstm_parameters=self.model.lstm_parameters,
            mlp_parameters=self.model.mlp_parameters,
            output_type="last", prefix="lstmsnn_x3")
